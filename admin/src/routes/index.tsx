...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "keywords",
        content: "德州婚恋,德州相亲,德州乾瑞,婚介,红娘服务,征婚交友",
      },
      {
        name: "description",
        content:
          "德州乾瑞婚恋服务有限公司，专注山东省各城市本地单身男女高品质婚恋交友与红娘一对一服务，提供优质单身资源、相亲活动、婚礼策划一站式服务。",
      },
    ],
  }),
})
  ...
  about: {
    ...
    content: (
      <div className="space-y-4 text-sm text-neutral-600 leading-relaxed">
        ...
        <p>
          热情接待新老客户，确切了解顾客需求，确保合同交货周期；及时进行质量跟踪，迅速处理质量异议。
        </p>
        <h4 className="font-bold text-neutral-800 text-base mt-4">经营理念</h4>
        <p>
          本公司坚持"客户得到满意、员工得到提升、企业得到发展"的企业经营理念，秉承"诚信赢天下"的经营理念。守合同、讲信用，携手新老客户，坚持质量效益型、管理效益型、科技效益型、环保节约型的发展道路。
        </p>
        ...
        <p className="bg-neutral-50 p-3 rounded border border-neutral-100">
          企业名称：德州乾瑞婚恋服务有限公司
          <br />
          信用代码：91371428MAKCPBR96B
          <br />
          公司地址：山东省德州市武城县广运街道文昌社区向阳路北首德百玫瑰园底商铺
          B 区 117 号 1 楼<br />
          联&nbsp;系&nbsp;人：管雪龙
          <br />
          联系电话：15688804736
  ...
  contact: {
    ...
    content: (
      <div className="space-y-4 text-sm text-neutral-600 leading-relaxed">
        ...
        <p>
          山东省德州市武城县广运街道文昌社区向阳路北首德百玫瑰园底商铺 B 区 117
          号 1 楼
        </p>
        ...
        <p>
          乘车请导航至"德百玫瑰园"，沿向阳路北首步行至底商铺 B 区 117 号 1
          楼即到。如需上门服务，建议提前致电预约红娘老师。
        </p>
      </div>
    ),
  },
  audit: {
    ...
    content: (
      <div className="space-y-4 text-sm text-neutral-600 leading-relaxed max-h-[60vh] overflow-y-auto pr-2">
        ...
        <p>
          网站发布的任何信息都必须遵守《中华人民共和国计算机系统安全保护条例》、《中华人民共和国计算机信息网络国际互联网管理暂行规定》、《互联网信息服务制度》等有关国家法律法规规定。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">第四条</h4>
        <p>
          为规范网站信息采集、审核和发布机制，实行上网信息审批制度，坚持"先审后上、分级负责、保证质量"的原则，未经审核信息一律不准发布。
        </p>
        ...
        <p>
          本公司网站发布的信息均为非密级信息，涉密信息不得出现在本公司网站上。个人隐私的相关信息，有损公司形象，对公司产生不利影响的信息均不得出现在本公司网站上。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">第七条</h4>
        <p>
          本公司网站上发布的信息应履行严格的审批程序，未经审核的信息不得出现在网站上。本公司网站上发布的信息内容必须由公司各级部门进行严格的初审、审核，应该遵守"谁审查谁负责""先审查后公开"的原则，确保对拟上传发布在网站上的信息进行审核后再发布。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">第八条</h4>
        <p>
          公司网络管理员每月对网站上发布的信息进行统计，每季度进行归纳总结，年底进行考核、评比。此项工作纳入部门年度工作考核范畴。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">第九条</h4>
        <p>
          对网站信息审查不严，发布涉密、虚假或者不良信息给公司造成不良影响的，公司将追究有关部门和人员的责任。
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4 text-sm text-neutral-600 leading-relaxed max-h-[60vh] overflow-y-auto pr-2">
          ...
          <table className="w-full text-left border-collapse border border-neutral-200">
            ...
            <tbody className="text-xs">
              <tr>
                ...
                <td className="border border-neutral-200 p-2 text-rose-600 font-bold">
                  100 元/年
                </td>
                <td className="border border-neutral-200 p-2 text-rose-600">
                  30% (30 元)
                </td>
                <td className="border border-neutral-200 p-2 text-emerald-600 font-bold">
                  70% (70 元)
                </td>
        ...
        <p className="text-[11px] text-neutral-400">
          说明：普通相亲用户支付的 100
          元线上展示会员费，资金通过微信支付官方“电商收付通”自动分账。平台收取
          30% 技术服务费，剩余 70% 归属对应入驻门店。线上会员订单 D+7
          自动分账、30%
          平台佣金、7天退款冷静期。资金全程由微信支付托管，平台不代收、不沉淀用户付款资金。
        </p>

        <h4 className="font-bold text-neutral-800 text-base mt-2">
          二、门店年度入驻展示费
        </h4>
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse border border-neutral-200">
            ...
            <tbody className="text-xs">
              <tr>
                ...
                <td className="border border-neutral-200 p-2 text-neutral-400">
                  不提供线上缴费
                </td>
                <td className="border border-neutral-200 p-2" rowSpan={2}>
                  线下签订纸质合作协议，门店对公转账至我司对公账户，公司给入驻门店开具正规增值税发票。
                </td>
              </tr>
        ...
        <p className="text-xs text-neutral-600">
          所有线上会员分润以微信官方分账记录为准；线下入驻年费以对公转账凭证、纸质合作协议作为结算依据。如需开具发票，请随时联系平台客服
          15688804736 (管老师)。
        </p>
        ...
        <p className="text-xs text-neutral-600">
          本站支持微信扫码在线收银渠道。所有入驻商户与付费会员均可联系平台客服
          15688804736 (管老师)
          索取正规增值税发票，平台将在3个工作日内开具并寄出。
        </p>
      </div>
    ),
  },
  refund: {
    ...
    content: (
      <div className="space-y-4 text-sm text-neutral-600 leading-relaxed max-h-[60vh] overflow-y-auto pr-2">
        ...
        <p>
          1.
          **未消费退款保障**：用户购买的第三方商家相亲服务商品（如派对门票、情感面谈等），在未实际体验或活动开始前，享有
          7 天内申请退款的权利。
        </p>
        <p>
          2.
          **商户责任退款**：因第三方商户原因导致服务取消、延期或履约品质不符的，用户有权向商户或平台客服发起全额退款申请。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">
          二、退款处理时效
        </h4>
        ...
        <p>
          2.
          若商家无故拖延，用户可申请平台客服介入仲裁，平台将在确认服务未消耗后，在
          2 个工作日内将争议资金原路退回至用户支付账户。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">
          三、纠纷与客诉通道
        </h4>
        <p>
          用户在交易过程中遇到服务质量纠纷，可拨打平台投诉专线 15688804736
          (管老师) 或发送邮件至
          qianchenhunlian@163.com。平台将根据事实依据介入促成调解并快速退款。
        </p>
      </div>
    ),
  },
  privacy: {
    ...
    content: (
      <div className="space-y-4 text-sm text-neutral-600 leading-relaxed max-h-[60vh] overflow-y-auto pr-2">
        ...
        <p>
          对于您的信息保护，我们承诺严格遵守《中华人民共和国个人信息保护法》《中华人民共和国网络安全法》等法律法规，按最小必要原则采集信息。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">
        ...
        <p>
          我们不会与本公司及关联方以外的任何公司、组织和个人共享您的个人信息，但以下情况除外：
        </p>
        <ul className="list-disc pl-5 space-y-1">
          <li>事先获得您明确的同意或授权；</li>
          <li>根据适用的法律法规要求、强制性的行政或司法要求所必须提供；</li>
          <li>
            在法律法规允许的范围内，为维护本公司、本公司关联方或合作伙伴、您或其他用户或社会公众利益、财产或安全免遭损害而有必要提供；
          </li>
          <li>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            在涉及合并、收购、资产转让或类似的交易时，如涉及到个人信息转让，我们会要求新的持有您个人信息的公司、组织继续受本协议的约束，否则,我们将要求该公司、组织重新向您征求授权同意。
          </li>
        </ul>
        ...
        <p>
          本公司承诺不公开或透露您的密码、手机号码等在本站的非公开信息。除非因会员本人的需要、法律或其他合法程序的要求、服务条款的改变或修订等。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">四、Cookie</h4>
        <p>
          在您使用本公司服务、参加网站活动、或访问网站网页时，网站自动接收并记录的您浏览器上的服务器数据，包括但不限于
          IP 地址、网站 Cookie 中的资料及您要求取用的网页记录。
        </p>
      </div>
    ),
  },
  register: {
    ...
    content: (
      <div className="space-y-4 text-sm text-neutral-600 leading-relaxed max-h-[60vh] overflow-y-auto pr-2">
        ...
        <p>
          您注册本公司相关服务时，根据网站要求提供相关个人信息；在您使用本公司服务、参加网站活动、或访问网站网页时，网站自动接收并记录的您浏览器上的服务器数据，包括但不限于
          IP 地址、网站 Cookie
          中的资料及您要求取用的网页记录；本公司承诺不公开或透露您的密码、手机号码等在本站的非公开信息。除非因会员本人的需要、法律或其他合法程序的要求、服务条款的改变或修订等。
        </p>
        <p>
          为服务用户的目的，本公司可能通过使用您的个人信息，向您提供服务，包括但不限于向您发出活动和服务信息等。
        </p>
        <p>同时会员须做到：</p>
        <ul className="list-disc pl-5 space-y-1">
          <li>
        ...
        <p>
          基于技术和不可预见的原因而导致的服务中断，或者因会员的非法操作而造成的损失，本公司不负责任。会员应当自行承担一切因自身行为而直接或者间接导致的民事或刑事法律责任。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">
          三、会员必须做到
        </h4>
        ...
        <p>
          任何会员在本站发表任何形式的信息，均表明该用户主动将该信息的发表权、汇编权、修改权、信息网络传播权无偿独家转让给本公司运营商。本协议已经构成《著作权法》第二十五条所规定的书面协议，并在用户同意本注册协议时生效，其效力及于用户此后在本站发布的任何内容。
        </p>
        <p>
          会员同意并明确了解上述条款，不将已发表于本站的信息，以任何形式发布或授权其他网站（及媒体）使用。同时，本公司保留删除站内各类不符合规定点评而不通知会员的权利。
        </p>
        <h4 className="font-bold text-neutral-800 text-base">五、免责声明</h4>
        <ul className="list-disc pl-5 space-y-1">
          <li>
            本公司是为互联网用户提供信息存储空间的互联网服务提供者，对于任何包含、经由或连接、下载或从任何与有关本网站所获得的任何内容、信息或广告，不声明或保证其正确性或可靠性；并且对于用户经本网站上的内容、广告、展示而购买、取得的任何产品、信息或资料，本公司不负保证责任。用户自行负担使用本网站的风险。
          </li>
          <li>
            本公司有权但无义务，改善或更正本网站任何部分之任何疏漏、错误。
          </li>
          <li>
            本站内相关信息内容仅代表发布者的个人观点，并不表示本站赞同其观点或证实其内容。
          </li>
        </ul>
      </div>
    ),
...
const SEED_PRODUCTS: ServiceProduct[] = [
  {
    id: "p_1",
    name: "玫瑰相亲派对现场门票",
    price: 99,
    ...
    desc: "参加本周末的玫瑰主题户外相亲派对，结识更多优秀单身青年。",
    specs: ["男士票", "女士票"],
  },
  {
    id: "p_2",
    ...
    desc: "专业的心理咨询师提供一对一的情感测评与疏导服务，解开您的情感困惑。",
    specs: ["单次咨询 (60分钟)"],
  },
  {
    id: "p_3",
...
function LandingPage() {
  ...
  const [merchantStatusResult, setMerchantStatusResult] =
  ...
  const handleMerchantApplySubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const creditCode = ((formData.get("creditCode") as string) || "")
      .trim()
      .toUpperCase()
  ...
  const handleOrderSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const newOrder: ServiceOrder = {
      ...
      productName:
        selectedProduct.name + (checkoutSpec ? ` (${checkoutSpec})` : ""),
  ...
  const handleLoginSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const matched = users.find(
      (u) => u.phone === username || u.nickname === username,
    )
    if (!matched) {
  ...
  const handleRegisterSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const agreeChk = (
      e.currentTarget.querySelector("#agreeChk") as HTMLInputElement
    ).checked
    if (!agreeChk) {
      setRegMsg(
        "请先阅读并勾选同意《注册协议》《隐私协议》《信息发布审核机制》",
      )
      return
    }
  ...
  const handlePostDelete = (postId: string) => {
    ...
    if (confirm("确定要删除这条征婚信息吗？")) {
      const updated = posts.filter(
        (p) => !(p.id === postId && p.uid === session.id),
      )
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-neutral-800 font-sans selection:bg-rose-100 selection:text-rose-600">
        ...
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center flex-wrap gap-2">
          <div className="flex gap-4 items-center">
            <span className="flex items-center gap-1">
              ...
              金牌红娘专线：
              <span className="font-bold text-white">15688804736</span>
            </span>
      ...
      <header className="bg-white border-b border-neutral-100 shadow-sm sticky top-0 z-40 backdrop-blur-md bg-white/95">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-neutral-900 tracking-wide">
                德州乾瑞婚恋服务
              </h1>
              <p className="text-xs text-neutral-500">
                真诚为媒 · 缘定一生 · 鲁ICP备2026034161号-2
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
              <a
                href="#about"
                className="text-neutral-600 hover:text-rose-500 transition"
              >
                关于我们
              </a>
              <a
              ...
              <a
                href="#mall"
                className="text-neutral-600 hover:text-rose-500 font-bold transition"
              >
                服务商城
              </a>
              <a
      ...
      <section
        id="features"
        className="bg-white py-12 border-b border-neutral-100"
      >
      ...
      <section
        id="about"
        className="py-16 bg-slate-50 border-b border-neutral-100"
      >
          ...
          <div className="bg-white p-8 rounded-2xl border border-neutral-100 shadow-sm space-y-4">
            ...
            <div className="space-y-3 text-sm text-neutral-600">
              <div className="flex gap-2">
                <span className="w-20 text-neutral-400 flex-shrink-0">
                  公司名称：
                </span>
              ...
              <div className="flex gap-2">
                ...
                <span className="text-neutral-800">
                  山东省德州市武城县广运街道文昌社区向阳路北首德百玫瑰园底商铺 B
                  区 117 号 1 楼
                </span>
              </div>
              <div className="flex gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-8 bg-rose-50/50 border border-rose-100 rounded-xl p-6">
            ...
            <ol className="list-decimal pl-5 text-neutral-600 text-xs space-y-2 leading-relaxed">
              <li>
                会员发布的所有信息（含征婚资料、图片、留言等）均需先经平台红娘审核，审核通过后方可对外展示。
              </li>
              <li>
                禁止发布虚假信息、色情低俗、违法违规、商业广告、骚扰他人等内容，一经发现立即下架并追究责任。
              </li>
              <li>
                所有会员需通过身份证实名认证，离异/丧偶会员需提交相关证明文件，单身证明真实有效。
              </li>
              <li>
                用户对自己发布的信息真实性负责，平台对涉嫌虚假/违法信息保留删除、封号、移交执法机关处理的权利。
              </li>
              <li>
                用户可通过投诉邮箱 qianchenhunlian@163.com 或联系电话
                15688804736 进行投诉与举报，平台在 24 小时内响应。
              </li>
            </ol>
            <button
              type="button"
          ...
          <div className="flex justify-between items-end flex-wrap gap-4 mb-8">
            <div>
              <h3 className="text-xl font-bold text-neutral-900">
                会员征婚{" "}
                <small className="text-neutral-500 font-normal text-xs ml-2">
                  已登记会员发布 · 真实有效
                </small>
              </h3>
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              {searchCityFilter && (
                <div className="flex items-center gap-2 animate-in fade-in duration-200">
                  ...
                  <select
                    value={
                      searchAreaFilter === searchCityFilter
                        ? ""
                        : searchAreaFilter
                    }
                    onChange={(e) => {
      ...
      <section
        id="mall"
        className="py-16 bg-slate-50/50 border-b border-neutral-100 scroll-mt-20"
      >
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-end flex-wrap gap-4 mb-8">
            <div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6 bg-white p-2 rounded-xl border border-neutral-100 shadow-sm">
            <div className="flex gap-2 overflow-x-auto pb-1 md:pb-0 scrollbar-hide">
              <button className="bg-rose-50 text-rose-600 px-4 py-1.5 rounded-lg text-sm font-bold whitespace-nowrap">
                全部商品
              </button>
              <button className="text-neutral-600 hover:bg-neutral-50 px-4 py-1.5 rounded-lg text-sm font-medium whitespace-nowrap transition">
                相亲活动
              </button>
              <button className="text-neutral-600 hover:bg-neutral-50 px-4 py-1.5 rounded-lg text-sm font-medium whitespace-nowrap transition">
                情感咨询
            ...
            <div className="hidden md:flex items-center gap-4 text-xs text-neutral-500 px-2 font-medium">
              <span className="flex items-center gap-1">
                <CheckCircle className="size-3.5 text-emerald-500" /> 严选商家
              </span>
              <span className="flex items-center gap-1">
                <CheckCircle className="size-3.5 text-emerald-500" /> 资金托管
              </span>
              <span className="flex items-center gap-1">
                <CheckCircle className="size-3.5 text-emerald-500" /> 售后无忧
              </span>
            </div>
          </div>
              ...
              >
                  ...
                  {product.tags && product.tags.length > 0 && (
                    <div className="absolute top-2 left-2 flex flex-col gap-1.5">
                      {product.tags.map((tag) => (
                        <span
                          key={tag}
                          className="bg-gradient-to-r from-rose-500 to-pink-500 text-white text-[10px] font-bold px-2 py-0.5 rounded shadow-sm tracking-wide"
                        >
                          {tag}
                        </span>
                      ))}
                ...
                <div className="p-3 md:p-4 flex flex-col flex-1">
                  ...
                  <div className="flex items-center gap-2 mb-3 mt-auto pt-2">
                    ...
                    <span className="text-[10px] md:text-xs text-rose-500 bg-rose-50 px-1.5 rounded-sm font-medium">
                      好评 100%
                    </span>
                  </div>
      ...
      <section
        id="merchants-list"
        className="py-16 bg-slate-50 border-b border-neutral-100 scroll-mt-20"
      >
        <div className="max-w-7xl mx-auto px-4">
                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex justify-between items-start">
                        ...
                        <Badge
                          variant="outline"
                          className="border-rose-100 bg-rose-50/50 text-rose-700 text-[10px]"
                        >
                          {m.category}
                        </Badge>
                      </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-neutral-500 text-xs mb-12">
            规范透明的一对一线下对接流程，保障靠谱安心
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 border-b border-neutral-800 pb-8 mb-8">
          <div className="lg:col-span-6 space-y-4">
            ...
            <p className="leading-relaxed text-neutral-400">
              德州乾瑞婚恋服务有限公司 ——
              以人为本、诚信务实、创新进取、回报社会。秉承"诚信赢天下"的经营理念，专注于山东省各城市本地单身男女实体高品质婚介服务。依托严格的实名制、专业红娘及完善的隐私安全保障，为周边单身男女提供一站式婚恋牵线解决方案。
            </p>
          ...
          <div className="lg:col-span-3">
            <h5 className="font-bold text-white text-sm mb-4">
              扫码联系金牌红娘
            </h5>
          ...
          <div className="flex flex-col items-center lg:items-end gap-2.5">
            <div className="text-center lg:text-right space-y-1">
              <p>
                本站受理违法和不良信息举报：
                <a
                  href="mailto:qianchenhunlian@163.com"
            ...
            <div className="p-6 max-h-[75vh] overflow-y-auto">
              ...
              <div className="mb-6 bg-rose-50/50 border border-rose-100/60 rounded-xl p-3.5">
                ...
                <div className="grid grid-cols-4 gap-1 text-center text-[10px] relative">
                  <div className="flex flex-col items-center">
                    <span className="size-5 rounded-full bg-rose-500 text-white flex items-center justify-center font-bold mb-1 shadow-sm">
                      1
                    </span>
                    <span className="text-rose-900 font-medium scale-90">
                      提交申请
                    </span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="size-5 rounded-full bg-rose-200 text-rose-700 flex items-center justify-center font-bold mb-1">
                      2
                    </span>
                  ...
                  {/* 连接线 */}
                  <div className="absolute top-2.5 left-[12%] right-[12%] h-[1px] bg-rose-200 z-[-1] hidden md:block" />
                </div>
              </div>
              ...
              <form onSubmit={handleMerchantApplySubmit} className="space-y-4">
                  ...
                  <div className="border-2 border-dashed border-neutral-200 rounded-xl p-4 text-center hover:bg-slate-50 transition cursor-pointer relative">
                    <input
                      ...
                      onChange={(e) => {
                        if (e.target.files?.[0]) {
                          triggerToast(
                            `营业执照: ${e.target.files[0].name} 已选择 (模拟上传成功)`,
                          )
                        }
                      }}
                    />
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-neutral-200 max-h-[120px] overflow-y-auto text-[10px] text-neutral-500 leading-relaxed space-y-1">
                  ...
                  <p>
                    1.
                    平台属于半开放平台，有意向的婚介门店需联系平台所在公司进行考察评估。
                  </p>
                  <p>
                    2.
                    考察通过后，由公司在后台为门店开立账号。门店需登录上传所有资质（含营业执照、地址、收费标准、定位等），并配合开通2-3个红娘工作账号。
                  </p>
                  <p className="font-bold text-neutral-600 mt-1">
                    二、服务收费与分润结算规则
                  </p>
                  <p>
                    1. 线上会员分润：用户在线支付 100 元平台展示会员费。平台收取
                    30% 技术服务费，剩余 70% 归属入驻门店。结算周期为 D+7
                    自动分账，包含 7
                    天退款冷静期。资金全程由微信支付“电商收付通”托管，平台不代收、不沉淀资金。
                  </p>
                  <p>
                    2. 门店年度入驻展示费：区县门店 300 元/年，市级门店 500
                    元/年。本平台不设线上交费通道，需双方线下签署合作协议，通过门店对公转账结算，平台开具增值税发票。
                  </p>
                  <p>
                    3.
                    结算凭证：线上分润以微信官方分账记录为准；线下入驻费以对公转账凭证和纸质协议为准。
                  </p>
                </div>
              ...
              {merchantStatusResult && (
                <div className="mt-5 border border-neutral-100 bg-slate-50 p-4 rounded-xl space-y-3 animate-in fade-in slide-in-from-top-2 duration-150">
                  ...
                  <div className="text-[11px] text-neutral-500 space-y-1">
                    ...
                    <p>
                      申请时间：
                      {new Date(merchantStatusResult.appliedAt).toLocaleString(
                        "zh-CN",
                      )}
                    </p>
                    {merchantStatusResult.status === "rejected" &&
                      merchantStatusResult.rejectReason && (
                        <p className="text-rose-500 font-bold">
                          驳回原因：{merchantStatusResult.rejectReason}
                        </p>
                      )}
                  </div>
                  {merchantStatusResult.status === "approved" && (

...
export const ActivityItemSchema = {
    ...
    type: 'object',
    required: ['counterpart_user_id', 'created_at'],
    title: 'ActivityItem'
} as const;
...
export const AdminMemberFullSchema = {
    properties: {
        member: {
            '$ref': '#/components/schemas/AdminMemberItem'
        },
        profile: {
            anyOf: [
                {
        ...
        can_view_contact: {
            type: 'boolean',
            title: 'Can View Contact',
            default: false
        }
    },
    type: 'object',
    required: ['member'],
    title: 'AdminMemberFull',
    description: '会员 360° 聚合: 一次请求拿全 (前端详情页专用).'
} as const;

export const AdminMemberItemSchema = {
    properties: {
        user_id: {
            type: 'string',
            format: 'uuid',
    ...
    title: 'AdminMemberItem',
    description: '会员列表行: User + Profile 摘要 (不含联系方式).'
} as const;

export const AdminMemberListSchema = {
    properties: {
        items: {
            items: {
                '$ref': '#/components/schemas/AdminMemberItem'
...
export const AuditLogPublicSchema = {
    ...
    type: 'object',
    required: ['id', 'actor_type', 'actor_id', 'action', 'created_at'],
...
export const BalanceTransactionListSchema = {
    properties: {
        items: {
            items: {
                '$ref': '#/components/schemas/BalanceTransactionPublic'
            },
            type: 'array',
            title: 'Items',
            default: []
    ...
    type: 'object',
    title: 'BalanceTransactionList'
} as const;

export const BalanceTransactionPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
    ...
    type: 'object',
    required: ['id', 'user_id', 'amount', 'balance_after', 'source', 'created_at'],
    title: 'BalanceTransactionPublic'
} as const;
...
export const ContactViewResponseSchema = {
    properties: {
        contact_wechat: {
            anyOf: [
                {
...
export const MemberCountsSchema = {
    properties: {
        favorites_given: {
            type: 'integer',
        ...
        affinity_given: {
            type: 'integer',
            title: 'Affinity Given',
            default: 0
        },
        affinity_received: {
            type: 'integer',
            title: 'Affinity Received',
            default: 0
        },
        requests_sent: {
            type: 'integer',

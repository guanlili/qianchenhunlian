...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "德州乾瑞婚恋服务有限公司，专注德州本地高品质婚恋交友与红娘一对一服务，提供优质单身资源、相亲活动、婚礼策划一站式服务。",
      },
    ],
  }),
})
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <p className="text-neutral-600 text-base md:text-lg max-w-2xl leading-relaxed">
              ...
              ，专注于山东德州本地单身男女提供高品质、全渠道、人工审核红娘对接服务，为每一份真爱保驾护航。
            </p>
          ...
          <div className="bg-white p-8 rounded-2xl border border-neutral-100 shadow-sm space-y-4">
            ...
            <div className="text-neutral-600 text-sm leading-relaxed space-y-4 text-justify">
              <p>
                ...
                的公司宗旨，以"诚信赢天下"为经营理念，专注本地高品质婚恋介绍与红娘一对一服务。
              </p>
              <p>
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 border-b border-neutral-800 pb-8 mb-8">
          <div className="lg:col-span-6 space-y-4">
            ...
            <p className="leading-relaxed text-neutral-400">
              德州乾瑞婚恋服务有限公司 —— 以人为本、诚信务实、创新进取、回报社会。秉承"诚信赢天下"的经营理念，专注于山东德州本地实体高品质婚介服务。依托严格的实名制、专业红娘及完善的隐私安全保障，为周边单身男女提供一站式婚恋牵线解决方案。
            </p>
